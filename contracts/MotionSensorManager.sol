...
contract MotionSensorManager {
    ...
    //struct para síntese de dados dos sensores de movimento
    struct MotionSensor {
    ...
    function registerMotionSensor(string memory _deviceID) public onlyAdmin {
        ...
        sensors[_deviceID] = MotionSensor({
    ...
    function isHumiditySensorAuthentic(string memory _deviceID) public view returns (bool) {
        MotionSensor memory device = sensors[_deviceID];
